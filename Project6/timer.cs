...
public class timer : MonoBehaviour
{
    ...
    private int goalReached;                    // Used to save the value of the goalReached variable from the diskRotation.cs script.
    ...
    void Update()
    {
        goalReached = Disk.GetComponent<diskRotation>().goalReached;    // Getting the value of goalReached from the diskRotation.cs script.
        resBtnClicked = Disk.GetComponent<restart>().resBtnClicked;     // Getting the value of resBtnClicked from the restart.cs script.
        roundNum = Disk.GetComponent<restart>().roundNum;               // Getting the value of roundNum from the restart.cs script.
