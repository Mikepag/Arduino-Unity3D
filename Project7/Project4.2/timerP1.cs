...
public class timerP1 : MonoBehaviour
{
    ...
    private string filename = "LogTimes_P1.txt";    // External file where the elapsed time of each round is beeing written.
    private string textToWrite = "Times:\n";        // The text that is beeing written to LogTimes_P1.txt. The first line is "Times:".
