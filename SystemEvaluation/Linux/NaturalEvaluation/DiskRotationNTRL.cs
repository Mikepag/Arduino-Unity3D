...
public class DiskRotationNTRL : MonoBehaviour
{
    ...
    void Update()   // Update is called once per frame
    {
        ...
        unfinCD = Disk.GetComponent<TimerNTRL>().unfinCD;                     // Getting the value of unfinCD from the timerNTRL.cs script.
        didCntdown = Disk.GetComponent<TimerNTRL>().didCntdown;               // Getting the value of didCntdown from the timerNTRL.cs script.
    ...
    void CheckRotation()
    {
        ...
        {                                                                                                           // If the input value is between the boundaries...
            ...
            {
                goalReached = 1;
                sp.Close();                                                                                     //...The goal has been successfully reached (for this round).
            }
