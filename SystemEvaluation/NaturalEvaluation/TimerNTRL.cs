...
public class TimerNTRL : MonoBehaviour
{
    ...
    private string filename = "LogTimes_Natural.txt";    // External file where the elapsed time of each round is beeing written.
    ...
    void Update()
    {
        goalReached = Disk.GetComponent<DiskRotationNTRL>().goalReached;          // Getting the value of goalReached from the diskRotationNTRL.cs script.
        roundNum = Disk.GetComponent<RestartNTRL>().roundNum;                     // Getting the value of roundNum from the restartNTRL.cs script.

        previous_resBtnClicked = resBtnClicked;                                 //Save the previous frame's resBtnClicked value.
        resBtnClicked = Disk.GetComponent<RestartNTRL>().resBtnClicked;           // Getting the current value of resBtnClicked from the restartNTRL.cs script.
